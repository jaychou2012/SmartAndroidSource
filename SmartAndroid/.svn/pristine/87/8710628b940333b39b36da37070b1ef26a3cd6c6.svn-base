 ...
 * }
 * 
 * UpperCamelCaseSeparatorNamingPolicy policy = new UpperCamelCaseSeparatorNamingPolicy(
 * 		&quot;_&quot;);
 ...
 * @author Joel Leitch
 */
final class UpperCamelCaseSeparatorNamingPolicy extends
	...
	public UpperCamelCaseSeparatorNamingPolicy(String separatorString) {
		super(new CamelCaseSeparatorNamingPolicy(separatorString),
				new ModifyFirstLetterNamingPolicy(
