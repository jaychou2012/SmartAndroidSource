...
final class TypeAdapterRuntimeTypeWrapper<T> extends TypeAdapter<T> {
	...
	TypeAdapterRuntimeTypeWrapper(MiniGson context, TypeAdapter<T> delegate,
			Type type) {
	...
	public void write(JsonWriter writer, T value) throws IOException {
		...
		TypeAdapter t = runtimeType != type ? context.getAdapter(TypeToken
				.get(runtimeType)) : delegate;
