package com.tandong.sa.tag.select;
 ...
 * <td>The element that is the root of the document. In HTML, this is the
 * <code>html</code> element</td>
 * <td><code>:root</code></td>
 * </tr>
 * <tr>
 ...
 * signification as <code>2n</code>.</td>
 * <td><code>tr:nth-child(2n+1)</code> finds every odd row of a table.
 * <code>:nth-child(10n-1)</code> the 9th, 19th, 29th, etc, element.
 * <code>li:nth-child(5)</code> the 5h li</td>
 * </tr>
 * <tr>
 * <td><code>:nth-last-child(<em>a</em>n+<em>b</em>)</code></td>
 * <td>elements that have <code><em>a</em>n+<em>b</em>-1</code> siblings
 * <b>after</b> it in the document tree. Otherwise like
 * <code>:nth-child()</code></td>
 * <td><code>tr:nth-last-child(-n+2)</code> the last two rows of a table</td>
 * </tr>
 * <tr>
 * <td><code>:nth-of-type(<em>a</em>n+<em>b</em>)</code></td>
 * <td>pseudo-class notation represents an element that has
 * <code><em>a</em>n+<em>b</em>-1</code> siblings with the same expanded element
 * name <em>before</em> it in the document tree, for any zero or positive
 * integer value of n, and has a parent element</td>
 ...
 * <td>pseudo-class notation represents an element that has
 * <code><em>a</em>n+<em>b</em>-1</code> siblings with the same expanded element
 * name <em>after</em> it in the document tree, for any zero or positive integer
 * value of n, and has a parent element</td>
 ...
 * <td>elements that are the first sibling of its type in the list of children
 * of its parent element</td>
 ...
 * <td>an element that has a parent element and whose parent element has no
 * other element children with the same expanded element name</td>
 * <td></td>
 * </tr>
 * <tr>
