 ...
 */
final class BSRQXInterpolator implements Interpolator {
	private static final BSRQXInterpolator INSTANCE = new BSRQXInterpolator();

	public final static BSRQXInterpolator getInstance() {
		return INSTANCE;
	}
