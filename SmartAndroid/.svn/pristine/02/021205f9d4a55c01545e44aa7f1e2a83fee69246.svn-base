...
import com.tandong.sa.sherlock.internal.app.ActionBarWrapper;
import com.tandong.sa.sherlock.internal.view.menu.MenuItemWrapper;
import com.tandong.sa.sherlock.internal.view.menu.MenuWrapper;
...
public class ActionBarSherlockNative extends ActionBarSherlock {
	...
	public ActionMode startActionMode(
			com.tandong.sa.sherlock.view.ActionMode.Callback callback) {
		if (ActionBarSherlock.DEBUG)
