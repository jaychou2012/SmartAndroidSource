...
/**
 * A stack data structure that only does a memory reference comparison when
 * looking for a particular item in the stack. This stack does not allow
 * {@code null} values to be added.
 * 
 * @author Joel Leitch
 */
final class MemoryRefStack {
	...
	/**
	 * Performs a memory reference check to see it the {@code obj} exists in the
	 * stack.
	 * 
	 * @param obj
