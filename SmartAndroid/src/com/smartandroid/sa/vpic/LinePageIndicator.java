...
public class LinePageIndicator extends View implements PageIndicator {
	...
	public LinePageIndicator(Context context, AttributeSet attrs) {
		this(context, attrs, context.getResources().getIdentifier(
				"vpiLinePageIndicatorStyle", "attrs", context.getPackageName()));
	...
	public LinePageIndicator(Context context, AttributeSet attrs, int defStyle) {
		...
		final float defaultGapWidth = res.getDimension(context.getResources()
				.getIdentifier("default_line_indicator_gap_width", "dimen",
						context.getPackageName()));
		...
		final float defaultStrokeWidth = res.getDimension(context
				.getResources().getIdentifier(
						"default_line_indicator_stroke_width", "dimen",
						context.getPackageName()));
		...
		final boolean defaultCentered = res.getBoolean(context.getResources()
				.getIdentifier("default_line_indicator_centered", "bool",
						context.getPackageName()));
		...
		TypedArray a = context.obtainStyledAttributes(
				attrs,
				new int[] { getResources().getIdentifier("LinePageIndicator",
		...
		mCentered = a
				.getBoolean(
						getResources().getIdentifier(
								"LinePageIndicator_centered", "styleable",
		...
		mLineWidth = a.getDimension(
				getResources().getIdentifier("LinePageIndicator_lineWidth",
		...
		mGapWidth = a
				.getDimension(
						getResources().getIdentifier(
								"LinePageIndicator_gapWidth", "styleable",
								context.getPackageName()), defaultGapWidth);
		// mGapWidth = a.getDimension(R.styleable.LinePageIndicator_gapWidth,
		// defaultGapWidth);
		setStrokeWidth(a.getDimension(
				getResources().getIdentifier("LinePageIndicator_strokeWidth",
						"styleable", context.getPackageName()),
				defaultStrokeWidth));
		// setStrokeWidth(a.getDimension(
		...
		mPaintUnselected.setColor(a.getColor(
				getResources().getIdentifier(
						"LinePageIndicator_unselectedColor", "styleable",
						context.getPackageName()), defaultUnselectedColor));
		// mPaintUnselected.setColor(a.getColor(
		// R.styleable.LinePageIndicator_unselectedColor,
		// defaultUnselectedColor));
		mPaintSelected.setColor(a.getColor(
				getResources().getIdentifier("LinePageIndicator_selectedColor",
						"styleable", context.getPackageName()),
		...
		Drawable background = a.getDrawable(getResources().getIdentifier(
				"LinePageIndicator_android_background", "styleable",
				context.getPackageName()));
