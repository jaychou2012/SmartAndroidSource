...
public class UnderlinePageIndicator extends View implements PageIndicator {
	...
	public UnderlinePageIndicator(Context context, AttributeSet attrs) {
		this(context, attrs, context.getResources().getIdentifier(
				"vpiUnderlinePageIndicatorStyle", "attr",
	...
	public UnderlinePageIndicator(Context context, AttributeSet attrs,
		...
		final boolean defaultFades = res.getBoolean(getResources()
				.getIdentifier("default_underline_indicator_fades", "bool",
						context.getPackageName()));
		...
		final int defaultFadeDelay = res.getInteger(getResources()
				.getIdentifier("default_underline_indicator_fade_delay",
		...
		final int defaultFadeLength = res.getInteger(getResources()
				.getIdentifier("default_underline_indicator_fade_length",
						"integer", context.getPackageName()));
		...
		final int defaultSelectedColor = res.getColor(getResources()
				.getIdentifier("default_underline_indicator_selected_color",
		...
		setFadeLength(a.getInteger(
				getResources().getIdentifier(
						"UnderlinePageIndicator_fadeLength", "styleable",
		...
		Drawable background = a.getDrawable(getResources().getIdentifier(
				"UnderlinePageIndicator_android_background", "styleable",
				context.getPackageName()));
