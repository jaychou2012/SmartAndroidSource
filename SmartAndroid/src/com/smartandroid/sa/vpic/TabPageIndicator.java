...
public class TabPageIndicator extends HorizontalScrollView implements
	...
	public TabPageIndicator(Context context, AttributeSet attrs) {
		...
		mTabLayout = new IcsLinearLayout(context, getResources().getIdentifier(
				"vpiTabPageIndicatorStyle", "attr", context.getPackageName()));
	...
	private class TabView extends TextView {
		...
		public TabView(Context context) {
			super(context, null, context.getResources().getIdentifier(
					"vpiTabPageIndicatorStyle", "attr",
