...
public class IconPageIndicator extends HorizontalScrollView implements
	...
	public IconPageIndicator(Context context, AttributeSet attrs) {
		...
		this.c = context;
		mIconsLayout = new IcsLinearLayout(context, getResources()
				.getIdentifier("vpiIconPageIndicatorStyle", "attr",
	...
	public void notifyDataSetChanged() {
		...
		for (int i = 0; i < count; i++) {
			ImageView view = new ImageView(getContext(), null, getResources()
					.getIdentifier("vpiIconPageIndicatorStyle", "attr",
							c.getPackageName()));
