...
import com.smartandroid.sa.pullto.internal.EmptyViewMethodAccessor;
	...
	protected void handleStyledAttributes(TypedArray a) {
		...
		mListViewExtrasEnabled = a.getBoolean(
				getResources().getIdentifier(
						"PullToRefresh_ptrListViewExtrasEnabled", "styleable",
						context.getPackageName()), true);
		// mListViewExtrasEnabled =
		// a.getBoolean(R.styleable.PullToRefresh_ptrListViewExtrasEnabled,
		// true);
		...
		if (mListViewExtrasEnabled) {
			...
			if (!a.hasValue(getResources().getIdentifier(
					"PullToRefresh_ptrScrollingWhileRefreshingEnabled", "styleable",
