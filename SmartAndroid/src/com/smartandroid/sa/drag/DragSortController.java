...
/**
 * Class that starts and stops item drags on a {@link DragListView}
 ...
 * {@link DragListView#setTouchListener()} and
 * {@link DragListView#setFloatViewManager()} of your
 * {@link DragListView} instance.
 */
public class DragSortController extends SimpleFloatViewManager implements View.OnTouchListener, GestureDetector.OnGestureListener {
    ...
    private DragListView mDslv;
    private int mPositionX;

    /**
     * Calls {@link #DragSortController(DragListView, int)} with a
     ...
     */
    public DragSortController(DragListView dslv) {
        this(dslv, 0, ON_DOWN, FLING_REMOVE);
    }

    public DragSortController(DragListView dslv, int dragHandleId, int dragInitMode, int removeMode) {
        this(dslv, dragHandleId, dragInitMode, removeMode, 0);
    }

    public DragSortController(DragListView dslv, int dragHandleId, int dragInitMode, int removeMode, int clickRemoveId) {
     ...
     */
    public DragSortController(DragListView dslv, int dragHandleId, int dragInitMode,
