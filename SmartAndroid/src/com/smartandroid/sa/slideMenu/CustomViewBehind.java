...
import com.smartandroid.sa.slideMenu.SlidingMenu.CanvasTransformer;
...
public class CustomViewBehind extends ViewGroup {
	...
	public void drawSelector(View content, Canvas canvas, float openPercent) {
		...
		if (mSelectorDrawable != null && mSelectedView != null) {
			String tag = (String) mSelectedView.getTag(getResources()
					.getIdentifier("selected_view", "id", c.getPackageName()));
	...
	public void setSelectedView(View v) {
		if (mSelectedView != null) {
			mSelectedView.setTag(
					getResources().getIdentifier("selected_view", "id",
		...
		if (v != null && v.getParent() != null) {
			...
			mSelectedView.setTag(
					getResources().getIdentifier("selected_view", "id",
							c.getPackageName()), TAG + "SelectedView");
			invalidate();
		}
	}
