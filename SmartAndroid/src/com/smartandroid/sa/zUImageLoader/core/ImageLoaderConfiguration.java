 ...
 *******************************************************************************/
package com.smartandroid.sa.zUImageLoader.core;
...
import com.smartandroid.sa.zUImageLoader.cache.disc.DiskCache;
import com.smartandroid.sa.zUImageLoader.cache.disc.naming.FileNameGenerator;
import com.smartandroid.sa.zUImageLoader.cache.memory.MemoryCache;
import com.smartandroid.sa.zUImageLoader.cache.memory.impl.FuzzyKeyMemoryCache;
import com.smartandroid.sa.zUImageLoader.core.assist.FlushedInputStream;
import com.smartandroid.sa.zUImageLoader.core.assist.ImageSize;
import com.smartandroid.sa.zUImageLoader.core.assist.QueueProcessingType;
import com.smartandroid.sa.zUImageLoader.core.decode.ImageDecoder;
import com.smartandroid.sa.zUImageLoader.core.download.ImageDownloader;
import com.smartandroid.sa.zUImageLoader.core.process.BitmapProcessor;
import com.smartandroid.sa.zUImageLoader.utils.L;
import com.smartandroid.sa.zUImageLoader.utils.MemoryCacheUtils;
...
public final class ImageLoaderConfiguration {
	...
	public static class Builder {
		 ...
		 */
		@Deprecated
		public Builder discCacheExtraOptions(int maxImageWidthForDiskCache,
				int maxImageHeightForDiskCache,
				BitmapProcessor processorForDiskCache) {
			return diskCacheExtraOptions(maxImageWidthForDiskCache,
					maxImageHeightForDiskCache, processorForDiskCache);
		}

		/**
		 * Sets options for resizing/compressing of downloaded images before
		 * saving to disk cache.<br />
		 ...
		 *            Maximum width of downloaded images for saving at disk
		 *            cache
		 * @param maxImageHeightForDiskCache
		 *            Maximum height of downloaded images for saving at disk
		 *            cache
		 ...
		 */
		public Builder diskCacheExtraOptions(int maxImageWidthForDiskCache,
				int maxImageHeightForDiskCache,
				BitmapProcessor processorForDiskCache) {
		 ...
		 * <b>cached on disk</b> images (these tasks are executed quickly so UIL
		 ...
		 * {@link #memoryCache(MemoryCache)} method to set your own
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.nostra13.universalimageloader.cache.disc.impl.ext.LruDiscCache
		 * LruDiscCache} will be used as disk cache. You can use
		 * {@link #diskCache(DiskCache)} method for introduction your own
		 ...
		 * <br />
		 * <b>NOTE:</b> If you set custom disk cache then following
		 * configuration option will not be considered:
		 * <ul>
	 ...
	 * problem</a> on slow networks using
	...
	private static class SlowNetworkImageDownloader implements ImageDownloader {
		...
		public InputStream getStream(String imageUri, Object extra)
				throws IOException {
			InputStream imageStream = wrappedDownloader.getStream(imageUri,
					extra);
			switch (Scheme.ofUri(imageUri)) {
			case HTTP:
			case HTTPS:
