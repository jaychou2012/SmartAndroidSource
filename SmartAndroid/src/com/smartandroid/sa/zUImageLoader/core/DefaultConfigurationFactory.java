...
import com.smartandroid.sa.zUImageLoader.cache.disc.impl.ext.LruDiscCache;
import com.smartandroid.sa.zUImageLoader.cache.disc.naming.FileNameGenerator;
import com.smartandroid.sa.zUImageLoader.cache.disc.naming.HashCodeFileNameGenerator;
...
import com.smartandroid.sa.zUImageLoader.core.assist.deque.LIFOLinkedBlockingDeque;
import com.smartandroid.sa.zUImageLoader.core.decode.BaseImageDecoder;
import com.smartandroid.sa.zUImageLoader.core.decode.ImageDecoder;
import com.smartandroid.sa.zUImageLoader.core.display.BitmapDisplayer;
import com.smartandroid.sa.zUImageLoader.core.display.SimpleBitmapDisplayer;
...
public class DefaultConfigurationFactory {
	...
	public static DiskCache createDiskCache(Context context,
		...
		if (diskCacheSize > 0 || diskCacheFileCount > 0) {
			...
			try {
				return new LruDiscCache(individualCacheDir, reserveCacheDir,
		...
		return new UnlimitedDiscCache(cacheDir, reserveCacheDir,
