 ...
 *******************************************************************************/
package com.smartandroid.sa.zUImageLoader.core.display;
...
public class RoundedVignetteBitmapDisplayer extends RoundedBitmapDisplayer {
	...
	public void display(Bitmap bitmap, ImageAware imageAware,
		...
		imageAware.setImageDrawable(new RoundedVignetteDrawable(bitmap,
				cornerRadius, margin));
	}
	...
	protected static class RoundedVignetteDrawable extends RoundedDrawable {
		...
		protected void onBoundsChange(Rect bounds) {
			...
			paint.setShader(new ComposeShader(bitmapShader, vignette,
