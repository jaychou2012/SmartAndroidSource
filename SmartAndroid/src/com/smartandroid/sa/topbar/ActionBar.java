...
package com.smartandroid.sa.topbar;
...
public class ActionBar extends RelativeLayout implements OnClickListener {
	...
	public ActionBar(Context context, AttributeSet attrs) {
		...
		mBarView = (RelativeLayout) mInflater.inflate(getResources()
				.getIdentifier("actionbar", "layout", context.getPackageName()),
				null);

		addView(mBarView);

		mLogoView = (ImageView) mBarView.findViewById(getResources()
				.getIdentifier("actionbar_home_logo", "id",
						context.getPackageName()));

		mHomeLayout = (RelativeLayout) mBarView
				.findViewById(getResources().getIdentifier("actionbar_home_bg",
						"id", context.getPackageName()));

		mHomeBtn = (ImageButton) mBarView.findViewById(getResources()
				.getIdentifier("actionbar_home_btn", "id",
						context.getPackageName()));

		mBackIndicator = mBarView.findViewById(getResources().getIdentifier(
				"actionbar_home_is_back", "id", context.getPackageName()));

		mTitleView = (TextView) mBarView.findViewById(getResources()
				.getIdentifier("actionbar_title", "id", context.getPackageName()));

		mActionsView = (LinearLayout) mBarView
				.findViewById(getResources().getIdentifier("actionbar_actions",
						"id", context.getPackageName()));

		mProgress = (ProgressBar) mBarView.findViewById(getResources()
				.getIdentifier("actionbar_progress", "id",
						context.getPackageName()));

		TypedArray a = context.obtainStyledAttributes(
				attrs,
				new int[] { getResources().getIdentifier("Actionbar", "styleable",
						context.getPackageName()) });
		// TypedArray a = context.obtainStyledAttributes(attrs,
		// R.styleable.ActionBar);
		CharSequence title = a.getString(getResources().getIdentifier(
				"Actionbar_title", "styleable", context.getPackageName()));
	...
	private View inflateAction(Action action) {
		View view = mInflater.inflate(
				getResources().getIdentifier("actionbar_item", "layout",
						c.getPackageName()), mActionsView, false);

		ImageButton labelView = (ImageButton) view
				.findViewById(getResources().getIdentifier("actionbar_item", "id",
						c.getPackageName()));
//		ImageButton labelView = (ImageButton) view
	...
	public static class IntentAction extends AbstractAction {
		...
		public void performAction(View view) {
			try {
				...
				Toast.makeText(mContext, "Failed to open intent...",
