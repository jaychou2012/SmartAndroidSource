package com.smartandroid.sa.sql.content;
...
import com.smartandroid.sa.sql.ActiveAndroid;
import com.smartandroid.sa.sql.Cache;
import com.smartandroid.sa.sql.Configuration;
...
public class ContentProvider extends android.content.ContentProvider {
	...
	public Uri insert(Uri uri, ContentValues values) {
		final Class<? extends Model> type = getModelType(uri);
		final Long id = Cache.openDatabase().insert(Cache.getTableName(type),
				null, values);
	...
	public int update(Uri uri, ContentValues values, String selection,
		...
		final Class<? extends Model> type = getModelType(uri);
		final int count = Cache.openDatabase().update(Cache.getTableName(type),
	...
	public int delete(Uri uri, String selection, String[] selectionArgs) {
		final Class<? extends Model> type = getModelType(uri);
		final int count = Cache.openDatabase().delete(Cache.getTableName(type),
	...
	public Cursor query(Uri uri, String[] projection, String selection,
		...
		final Cursor cursor = Cache.openDatabase().query(
				Cache.getTableName(type), projection, selection, selectionArgs,
				null, null, sortOrder);
