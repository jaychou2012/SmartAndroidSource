...
import com.smartandroid.sa.tag.nodes.XmlDeclaration;
...
public abstract class Evaluator {
	...
	public static final class AttributeStarting extends Evaluator {
		...
		@Override
		public boolean matches(Element root, Element element) {
			List<com.smartandroid.sa.tag.nodes.Attribute> values = element
					.attributes().asList();
			for (com.smartandroid.sa.tag.nodes.Attribute attribute : values) {
	...
	public static final class IsNthLastChild extends CssNthEvaluator {
		...
		@Override
		protected int calculatePosition(Element root, Element element) {
			return element.parent().children().size()
	...
	public static final class IsOnlyChild extends Evaluator {
		...
		public boolean matches(Element root, Element element) {
			final Element p = element.parent();
			return p != null && !(p instanceof Document)
					&& element.siblingElements().size() == 0;
		}
