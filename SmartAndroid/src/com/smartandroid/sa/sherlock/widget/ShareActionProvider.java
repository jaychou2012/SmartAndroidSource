...
import com.smartandroid.sa.sherlock.view.MenuItem.OnMenuItemClickListener;
import com.smartandroid.sa.sherlock.widget.ActivityChooserModel.OnChooseActivityListener;
...
public class ShareActionProvider extends ActionProvider {
	...
	public View onCreateActionView() {
		...
		mContext.getTheme().resolveAttribute(
				mContext.getResources().getIdentifier(
						"actionModeShareDrawable", "attr",
						mContext.getPackageName()),
				// mContext.getTheme().resolveAttribute(R.attr.actionModeShareDrawable,
				outTypedValue, true);
		...
		activityChooserView.setDefaultActionButtonContentDescription(mContext
		...
		activityChooserView
				.setExpandActivityOverflowButtonContentDescription(mContext
						.getResources().getIdentifier(
	...
	public void onPrepareSubMenu(SubMenu subMenu) {
		...
		if (collapsedActivityCount < expandedActivityCount) {
			...
			SubMenu expandedSubMenu = subMenu.addSubMenu(
					...
					collapsedActivityCount,
					mContext.getString(mContext.getResources().getIdentifier(
							"abs__activity_chooser_view_see_all", "string",
							mContext.getPackageName())));
	 ...
	 * such.
	 */
	private class ShareAcitivityChooserModelPolicy implements
