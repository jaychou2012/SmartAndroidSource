...
public class ActionBarContainer extends NineFrameLayout {
	...
	public ActionBarContainer(Context context, AttributeSet attrs) {
		...
		mBackground = a.getDrawable(getResources().getIdentifier(
				"SherlockActionBar_background", "styleable",
				context.getPackageName()));
		// mBackground =
		// a.getDrawable(R.styleable.SherlockActionBar_background);
		mStackedBackground = a.getDrawable(getResources().getIdentifier(
				"SherlockActionBar_backgroundStacked", "styleable",
				context.getPackageName()));
		...
		if (getId() == getResources().getIdentifier("abs__split_action_bar",
				"id", context.getPackageName())) {
			// if (getId() == R.id.abs__split_action_bar) {
			mIsSplit = true;
			mSplitBackground = a.getDrawable(getResources().getIdentifier(
					"SherlockActionBar_backgroundSplit", "styleable",
					context.getPackageName()));
	...
	public void onFinishInflate() {
		...
		mActionBarView = (ActionBarView) findViewById(getResources()
				.getIdentifier("abs__action_bar", "id", c.getPackageName()));
