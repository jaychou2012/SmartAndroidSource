...
public class IcsSpinner extends IcsAbsSpinner implements OnClickListener {
	...
	public IcsSpinner(Context context, AttributeSet attrs) {
		this(context, attrs, context.getResources().getIdentifier(
				"actionDropDownStyle", "attr", context.getPackageName()));
	...
	public IcsSpinner(Context context, AttributeSet attrs, int defStyle) {
		...
		TypedArray a = context.obtainStyledAttributes(
				attrs,
				new int[] { getResources().getIdentifier("SherlockSpinner",
		...
		mDropDownWidth = a.getLayoutDimension(
				getResources().getIdentifier(
						"SherlockSpinner_android_dropDownWidth", "styleable",
						context.getPackageName()),
				// R.styleable.SherlockSpinner_android_dropDownWidth,
				ViewGroup.LayoutParams.WRAP_CONTENT);
		popup.setBackgroundDrawable(a.getDrawable(getResources().getIdentifier(
				"SherlockSpinner_android_popupBackground", "styleable",
				context.getPackageName())));
		...
		mGravity = a.getInt(
				getResources().getIdentifier("SherlockSpinner_android_gravity",
						"styleable", context.getPackageName()),
				// mGravity =
				// a.getInt(R.styleable.SherlockSpinner_android_gravity,
				Gravity.CENTER);

		mPopup.setPromptText(a.getString(getResources().getIdentifier(
				"SherlockSpinner_android_prompt", "styleable",
				context.getPackageName())));
