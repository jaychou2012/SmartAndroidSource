...
import com.smartandroid.sa.sherlock.internal.nineoldandroids.widget.NineLinearLayout;
...
public class ActionBarContextView extends AbsActionBarView implements
	...
	public ActionBarContextView(Context context, AttributeSet attrs) {
		this(context, attrs, context.getResources().getIdentifier(
				"actionModeStyle", "attrs", context.getPackageName()));
	...
	public ActionBarContextView(Context context, AttributeSet attrs,
		...
		TypedArray a = context.obtainStyledAttributes(
				attrs,
				new int[] { getResources().getIdentifier("SherlockActionMode",
						"styleable", context.getPackageName()) }, defStyle, 0);
		// R.styleable.SherlockActionMode, defStyle, 0);
		setBackgroundDrawable(a.getDrawable(getResources().getIdentifier(
				"SherlockActionMode_background", "styleable",
				context.getPackageName())));
		// .getDrawable(R.styleable.SherlockActionMode_background));
		mTitleStyleRes = a.getResourceId(
				getResources().getIdentifier(
						"SherlockActionMode_titleTextStyle", "styleable",
						context.getPackageName()), 0);
		// R.styleable.SherlockActionMode_titleTextStyle, 0);
		mSubtitleStyleRes = a.getResourceId(
				getResources().getIdentifier(
						"SherlockActionMode_subtitleTextStyle", "styleable",
						context.getPackageName()), 0);
		// R.styleable.SherlockActionMode_subtitleTextStyle, 0);

		mContentHeight = a.getLayoutDimension(
				getResources().getIdentifier("SherlockActionMode_height",
						"styleable", context.getPackageName()), 0);
		// R.styleable.SherlockActionMode_height, 0);

		mSplitBackground = a.getDrawable(getResources().getIdentifier(
				"SherlockActionMode_backgroundSplit", "styleable",
				context.getPackageName()));
		...
		if (mTitleLayout == null) {
			...
			inflater.inflate(
					getResources().getIdentifier("abs__action_bar_title_item",
							"layout", mContext.getPackageName()), this);
	...
	public void initForMode(final ActionMode mode) {
		if (mClose == null) {
			...
			mClose = (NineLinearLayout) inflater.inflate(
					getResources().getIdentifier("abs__action_mode_close_item",
							"layout", mContext.getPackageName()), this, false);
		...
		View closeButton = mClose.findViewById(getResources().getIdentifier(
				"abs__action_mode_close_button", "id",
				mContext.getPackageName()));
