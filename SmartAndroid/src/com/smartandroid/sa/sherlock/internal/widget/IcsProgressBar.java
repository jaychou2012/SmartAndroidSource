...
public class IcsProgressBar extends View {
	...
	public IcsProgressBar(Context context, AttributeSet attrs, int defStyle,
		...
		setSecondaryProgress(a.getInt(
				/* R.styleable. */ProgressBar_secondaryProgress,
				mSecondaryProgress));
		...
		mAnimationResolution = a.getInteger(
	 ...
	 * @hide
	 * 
	 @Override public int getResolvedLayoutDirection(Drawable who) { return (who
	 *           == mProgressDrawable || who == mIndeterminateDrawable) ?
