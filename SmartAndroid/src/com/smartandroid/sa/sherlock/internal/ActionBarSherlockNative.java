...
import com.smartandroid.sa.sherlock.internal.app.ActionBarWrapper;
import com.smartandroid.sa.sherlock.internal.view.menu.MenuItemWrapper;
import com.smartandroid.sa.sherlock.internal.view.menu.MenuWrapper;
...
public class ActionBarSherlockNative extends ActionBarSherlock {
		...
		if (mMenu == null) {
			if (item.getItemId() != android.R.id.home) {
				throw new IllegalStateException(
						"Non-home action item clicked before onCreateOptionsMenu with ID "
								+ item.getItemId());
			}
	...
	public ActionMode startActionMode(
			com.smartandroid.sa.sherlock.view.ActionMode.Callback callback) {
		if (ActionBarSherlock.DEBUG)
