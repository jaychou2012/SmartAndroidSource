...
import com.smartandroid.sa.animation.Animator;
import com.smartandroid.sa.animation.AnimatorListenerAdapter;
import com.smartandroid.sa.animation.AnimatorSet;
import com.smartandroid.sa.animation.ObjectAnimator;
import com.smartandroid.sa.animation.Animator.AnimatorListener;
import com.smartandroid.sa.sherlock.app.ActionBar;
import com.smartandroid.sa.sherlock.internal.nineoldandroids.widget.NineFrameLayout;
import com.smartandroid.sa.sherlock.internal.view.menu.MenuBuilder;
import com.smartandroid.sa.sherlock.internal.view.menu.MenuPopupHelper;
...
import com.smartandroid.sa.sherlock.internal.widget.ScrollingTabContainerView;
...
public class ActionBarImpl extends ActionBar {
	...
	private void init(View decor) {
		...
		mActionView = (ActionBarView) decor.findViewById(mContext
				.getResources().getIdentifier("abs__action_bar", "id",
						mContext.getPackageName()));
		// mActionView = (ActionBarView)
		// decor.findViewById(R.id.abs__action_bar);
		mContextView = (ActionBarContextView) decor.findViewById(mContext
				.getResources().getIdentifier("abs__action_context_bar", "id",
						mContext.getPackageName()));
		// .findViewById(R.id.abs__action_context_bar);
		mContainerView = (ActionBarContainer) decor.findViewById(mContext
				.getResources().getIdentifier("abs__action_bar_container",
						"id", mContext.getPackageName()));
		// .findViewById(R.id.abs__action_bar_container);
		mSplitView = (ActionBarContainer) decor.findViewById(mContext
				.getResources().getIdentifier("abs__split_action_bar", "id",
						mContext.getPackageName()));
		...
		int tabs_id = mContext.getResources()
				.getIdentifier("abs__action_bar_embed_tabs", "bool",
						mContext.getPackageName());
		setHasEmbeddedTabs(getResources_getBoolean(mContext, tabs_id));
		// R.bool.abs__action_bar_embed_tabs));
	}

	public void onConfigurationChanged(Configuration newConfig) {
		setHasEmbeddedTabs(getResources_getBoolean(
				mContext,
				mContext.getResources().getIdentifier(
						"abs__action_bar_embed_tabs", "bool",
						mContext.getPackageName())));
		// R.bool.abs__action_bar_embed_tabs));
