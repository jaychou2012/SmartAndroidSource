 ...
 * <p>
 * For more information about creating menus, read the <a href="{@docRoot}
...
public interface Menu {
	 ...
	 * actions on the data that is currently displayed -- or/add this with your
	 * base value.
	 */
	 ...
	 * 
	 * @param groupId
	 *            The group identifier that this item should be part of. This
	 *            can be used to define groups of items for batch state changes.
	 *            Normally use {@link #NONE} if an item should not be in a
	 *            group.
	 * @param itemId
	 *            Unique item ID. Use {@link #NONE} if you do not need a unique
	 *            ID.
	 * @param order
	 *            The order for the item. Use {@link #NONE} if you do not care
	 ...
	 * @param groupId
	 *            The group identifier that this item should be part of. This
	 *            can also be used to define groups of items for batch state
	 *            changes. Normally use {@link #NONE} if an item should not be
	 *            in a group.
	 * @param itemId
	 *            Unique item ID. Use {@link #NONE} if you do not need a unique
	 *            ID.
	 ...
	 * @return The newly added sub-menu
	 */
	SubMenu addSubMenu(final int groupId, final int itemId, int order,
	 ...
	 * 
	 * @param groupId
	 *            The group identifier that the items should be part of. This
	 *            can also be used to define groups of items for batch state
	 *            changes. Normally use {@link #NONE} if the items should not be
	 *            in a group.
	 * @param itemId
	 *            Unique item ID. Use {@link #NONE} if you do not need a unique
	 *            ID.
	 * @param order
	 *            The order for the items. Use {@link #NONE} if you do not care
	 *            about the order. See {@link MenuItem#getOrder()}.
	 * @param caller
	 ...
	 *            queryIntentActivityOptions().
	 * @param intent
	 *            Intent describing the kinds of items to populate in the list
	 *            as defined by queryIntentActivityOptions().
	 * @param flags
	 ...
	 *            generated for each of the <var>specifics</var> that were
	 *            requested. Entries may be null if no activity was found for
	 ...
	 * 
	 * @param groupId
	 *            The group to be removed. If there are no items in this group,
	 *            nothing happens.
	 */
	 ...
	 * is similar to calling {@link MenuItem#setCheckable} on all of the menu
	 * items with the given group identifier, but in addition you can control
	 * whether this group contains a mutually-exclusive set items. This should
	 * be called after the items of the group have been added to the menu.
	 * 
	 * @param group
	 ...
	 *            default is false.
	 * @param exclusive
	 *            If set to true, only one item in this group can be checked at
	 *            a time; checking an item will automatically uncheck all others
	 *            in the group. If set to false, each item can be checked
	 ...
	 * 
	 * @return The menu item object, or null if there is no item with this
	 *         identifier.
	 */
	public MenuItem findItem(int id);

	/**
	 * Get the number of items in the menu. Note that this will change any times
	 * items are added or removed from the menu.
	 * 
	 ...
	 * 
	 * @return If the given shortcut exists and is shown, returns true; else
	 *         returns false.
	 * 
	 ...
	 *            Additional option flags or 0.
	 * 
	 * @return If the given identifier exists and is shown, returns true; else
	 *         returns false.
	 * 
	 * @see #FLAG_PERFORM_NO_CLOSE
	 */
	 ...
	 * 
	 * @param isQwerty
	 *            If true the menu will use alphabetic shortcuts; else it will
