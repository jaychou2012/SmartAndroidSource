...
public abstract class ActionProvider {
	 ...
	 * Activity.onOptionsItemSelected(MenuItem)}</li>
	 * <li>
	 * Receiving a call to
	 ...
	 * MenuItem.setIntent(android.content.Intent)}</li>
	 * <li>
	 ...
	 * {@link #onPrepareSubMenu(SubMenu)} after the call to
	 * {@link #onPerformDefaultAction()} and before a submenu is displayed to
	 * the user.
	 * 
