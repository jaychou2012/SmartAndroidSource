 ...
 * @author Joel Leitch
 */
final class JsonObjectDeserializationVisitor<T> extends
	...
	JsonObjectDeserializationVisitor(JsonElement json, Type type,
		...
		super(json, type, objectNavigator, fieldNamingPolicy,
	...
	public void visitArray(Object array, Type componentType) {
		...
		throw new JsonParseException("Expecting object but found array: "
				+ array);
	}
	...
	public boolean visitFieldUsingCustomHandler(FieldAttributes f,
		...
		try {
			...
			if (child == null) { // Child will be null if the field wasn't
									// present in Json
				return true;
			...
			ObjectTypePair objTypePair = new ObjectTypePair(null,
