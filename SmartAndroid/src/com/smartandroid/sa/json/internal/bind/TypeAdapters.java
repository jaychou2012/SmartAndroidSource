...
public final class TypeAdapters {
	...
	public static final TypeAdapter.Factory BOOLEAN_FACTORY = newFactory(
	...
	public static final TypeAdapter.Factory INTEGER_FACTORY = newFactory(
	...
	public static final TypeAdapter.Factory LONG_FACTORY = newFactory(
	...
	public static final TypeAdapter.Factory DOUBLE_FACTORY = newFactory(
	...
	public static final TypeAdapter.Factory FLOAT_FACTORY = newFactory(
	...
	public static final TypeAdapter.Factory STRING_FACTORY = newFactory(
			String.class, STRING);
	...
	public static <T> TypeAdapter.Factory newFactory(final TypeToken<T> type,
		...
		return new TypeAdapter.Factory() {
			...
			public <T> TypeAdapter<T> create(MiniGson context,
				...
				return typeToken.equals(type) ? (TypeAdapter<T>) typeAdapter
						: null;
			}
		};
	}

	public static <T> TypeAdapter.Factory newFactory(final Class<T> type,
			final TypeAdapter<T> typeAdapter) {
		return new TypeAdapter.Factory() {
			@SuppressWarnings("unchecked")
			// we use a runtime check to make sure the 'T's equal
			public <T> TypeAdapter<T> create(MiniGson context,
					TypeToken<T> typeToken) {
				return typeToken.getRawType() == type ? (TypeAdapter<T>) typeAdapter
						: null;
			}
		};
	}

	public static <T> TypeAdapter.Factory newFactory(final Class<T> unboxed,
			final Class<T> boxed, final TypeAdapter<T> typeAdapter) {
		return new TypeAdapter.Factory() {
			@SuppressWarnings("unchecked")
			// we use a runtime check to make sure the 'T's equal
			public <T> TypeAdapter<T> create(MiniGson context,
				...
				return (rawType == unboxed || rawType == boxed) ? (TypeAdapter<T>) typeAdapter
						: null;
			}
		};
	}
