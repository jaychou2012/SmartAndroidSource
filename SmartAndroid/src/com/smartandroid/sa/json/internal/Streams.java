...
package com.smartandroid.sa.json.internal;
...
import com.smartandroid.sa.json.JsonArray;
import com.smartandroid.sa.json.JsonElement;
import com.smartandroid.sa.json.JsonIOException;
import com.smartandroid.sa.json.JsonNull;
import com.smartandroid.sa.json.JsonObject;
import com.smartandroid.sa.json.JsonParseException;
import com.smartandroid.sa.json.JsonPrimitive;
import com.smartandroid.sa.json.JsonSyntaxException;
...
public final class Streams {
	 ...
	 */
	public static void write(JsonElement element, boolean serializeNulls,
		...
		if (element == null || element.isJsonNull()) {
			...
			writer.beginObject();
			for (Map.Entry<String, JsonElement> e : element.getAsJsonObject()
					.entrySet()) {
