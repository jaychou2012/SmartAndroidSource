...
import static com.smartandroid.sa.json.internal.$Gson$Preconditions.checkArgument;
import static com.smartandroid.sa.json.internal.$Gson$Preconditions.checkNotNull;
...
public final class $Gson$Types {
	...
	static Type getSupertype(Type context, Class<?> contextRawType,
		...
		return resolve(context, contextRawType,
				$Gson$Types.getGenericSupertype(context, contextRawType,
						supertype));
	}
