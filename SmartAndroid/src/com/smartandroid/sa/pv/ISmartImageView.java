...
public interface ISmartImageView {
     ...
     * @param listener - Listener to be registered.
     */
    void setOnMatrixChangeListener(SmartImageViewAttacher.OnMatrixChangedListener listener);
     ...
     * @param listener - Listener to be registered.
     */
    void setOnPhotoTapListener(SmartImageViewAttacher.OnPhotoTapListener listener);
     ...
     */
    SmartImageViewAttacher.OnPhotoTapListener getOnPhotoTapListener();
     ...
     * @param listener - Listener to be registered.
     */
    void setOnViewTapListener(SmartImageViewAttacher.OnViewTapListener listener);
     ...
     */
    SmartImageViewAttacher.OnViewTapListener getOnViewTapListener();
     ...
     */
    ISmartImageView getIPhotoViewImplementation();
