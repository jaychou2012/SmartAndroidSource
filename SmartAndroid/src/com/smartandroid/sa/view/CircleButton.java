	...
	private void init(Context context, AttributeSet attrs) {
		...
		if (attrs != null) {
			final TypedArray a = context.obtainStyledAttributes(
					attrs,
					new int[] { getResources().getIdentifier("CircleButton",
							"styleable", context.getPackageName()) });
			// final TypedArray a = context.obtainStyledAttributes(attrs,
			// R.styleable.CircleButton);
			color = a.getColor(
					getResources().getIdentifier("CircleButton_cb_color",
							"styleable", context.getPackageName()), color);
			// color = a.getColor(R.styleable.CircleButton_cb_color, color);
			pressedRingWidth = (int) a.getDimension(
					getResources().getIdentifier(
							"CircleButton_cb_pressed_ring_width", "styleable",
							context.getPackageName()),
					// R.styleable.CircleButton_cb_pressed_ring_width,
					pressedRingWidth);
			a.recycle();
		}
