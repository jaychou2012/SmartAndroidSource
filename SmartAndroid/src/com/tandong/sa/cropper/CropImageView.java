...
public class CropImageView extends FrameLayout {
	...
	public static final int[] CropImageView = { 0x7f010000, 0x7f010001,
	...
	public CropImageView(Context context, AttributeSet attrs) {
		...
		TypedArray ta = context.obtainStyledAttributes(attrs, CropImageView, 0,
				0);
		//
	...
	public Bitmap getCroppedImage() {
		...
		final Bitmap croppedBitmap = Bitmap.createBitmap(mBitmap,
				(int) actualCropX, (int) actualCropY, (int) actualCropWidth,
	...
	private void init(Context context) {
		...
		final View v = inflater.inflate(
				getResources().getIdentifier("crop_image_view", "layout",
						context.getPackageName()), this, true);
		// final View v = inflater.inflate(R.layout.crop_image_view, this,
		// true);

		mImageView = (ImageView) v.findViewById(getResources().getIdentifier(
				"ImageView_image", "id", context.getPackageName()));
		// mImageView = (ImageView) v.findViewById(R.id.ImageView_image);

		setImageResource(mImageResource);
		mCropOverlayView = (CropOverlayView) v.findViewById(getResources()
				.getIdentifier("CropOverlayView", "id",
