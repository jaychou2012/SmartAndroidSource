...
import com.tandong.sa.sherlock.internal.view.View_HasStateListenerSupport;
import com.tandong.sa.sherlock.internal.view.View_OnAttachStateChangeListener;
import com.tandong.sa.sherlock.internal.widget.CapitalizingButton;
import com.tandong.sa.sherlock.internal.widget.IcsToast;
...
public class ActionMenuItemView extends LinearLayout implements
	...
	public ActionMenuItemView(Context context, AttributeSet attrs, int defStyle) {
		...
		super(context, attrs);
		this.c = context;
		mAllowTextWithIcon = getResources_getBoolean(
				context,
		...
		TypedArray a = context.obtainStyledAttributes(
				...
				new int[] { getResources().getIdentifier(
						"SherlockActionMenuItemView", "styleable",
	...
	public void onFinishInflate() {
		...
		mImageButton = (ImageButton) findViewById(getResources().getIdentifier(
				"abs__imageButton", "id", c.getPackageName()));
		// mImageButton = (ImageButton) findViewById(R.id.abs__imageButton);
		mTextButton = (CapitalizingButton) findViewById(getResources()
				.getIdentifier("abs__textButton", "id", c.getPackageName()));
		// mTextButton = (CapitalizingButton)
	...
	public boolean onLongClick(View v) {
		...
		Toast cheatSheet = IcsToast.makeText(context, mItemData.getTitle(),
