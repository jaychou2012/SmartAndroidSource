...
import com.tandong.sa.sherlock.internal.view.menu.ActionMenuView.ActionMenuChildView;
import com.tandong.sa.sherlock.view.ActionProvider;
import com.tandong.sa.sherlock.view.MenuItem;
import static com.tandong.sa.sherlock.internal.ResourcesCompat.getResources_getInteger;
...
public class ActionMenuPresenter extends BaseMenuPresenter implements
	...
	public ActionMenuPresenter(Context context) {
		super(context, context.getResources().getIdentifier(
				"abs__action_menu_layout", "layout", context.getPackageName()),
		// super(context, R.layout.abs__action_menu_layout,
				context.getResources().getIdentifier(
						"abs__action_menu_item_layout", "layout",
	...
	public void initForMenu(Context context, MenuBuilder menu) {
		...
		if (!mMaxItemsSet) {
			mMaxItems = getResources_getInteger(
					context,
					context.getResources().getIdentifier(
							"abs__max_action_buttons", "integer",
							context.getPackageName()));
