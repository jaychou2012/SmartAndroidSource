...
public class ListMenuItemView extends LinearLayout implements MenuView.ItemView {
	...
	public ListMenuItemView(Context context, AttributeSet attrs, int defStyle) {
		...
		TypedArray a = context.obtainStyledAttributes(
				attrs,
				new int[] { getResources().getIdentifier("SherlockMenuView",
	...
	protected void onFinishInflate() {
		...
		mTitleView = (TextView) findViewById(getResources().getIdentifier(
		...
		mShortcutView = (TextView) findViewById(getResources().getIdentifier(
				"abs__shortcut", "id", mContext.getPackageName()));
	...
	private void insertIconView() {
		...
		mIconView = (ImageView) inflater.inflate(
				getResources().getIdentifier("abs__list_menu_item_icon",
	...
	private void insertRadioButton() {
		...
		mRadioButton = (RadioButton) inflater.inflate(
				getResources().getIdentifier("abs__list_menu_item_radio",
						"layout", mContext.getPackageName()), this, false);
	...
	private void insertCheckBox() {
		...
		mCheckBox = (CheckBox) inflater.inflate(
				getResources().getIdentifier("abs__list_menu_item_checkbox",
						"layout", mContext.getPackageName()), this, false);
