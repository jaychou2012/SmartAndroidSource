 ...
 * @author Joel Leitch
 */
public final class JsonArray extends JsonElement implements
	...
	/**
	 * convenience method to get this array as an Object if it contains a single
	 * element.
	 * 
	 * @return get this element as an Object if it is single element array.
	 * @throws ClassCastException
	 *             if the element in the array is of not a {@link JsonPrimitive}
	 *             and is not a valid Object.
	 * @throws IllegalStateException
	 *             if the array has more than one element.
	 */
	@Override
