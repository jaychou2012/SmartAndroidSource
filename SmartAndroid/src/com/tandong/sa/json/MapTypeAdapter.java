...
/**
 * Default serialization and deserialization of a map type. This implementation
 * really only works well with simple primitive types as the map key. If the key
 * is not a simple primitive then the object is {@code toString}ed and that
 * value is used as its key.
 * 
 * @author Joel Leitch
 */
...
final class MapTypeAdapter extends BaseMapTypeAdapter {
	...
	public JsonElement serialize(Map src, Type typeOfSrc,
		...
		if (typeOfSrc instanceof ParameterizedType) {
			...
			childGenericType = $Gson$Types.getMapKeyAndValueTypes(typeOfSrc,
					rawTypeOfSrc)[1];
		}
	...
	public Map deserialize(JsonElement json, Type typeOfT,
		...
		Type[] keyAndValueTypes = $Gson$Types.getMapKeyAndValueTypes(typeOfT,
