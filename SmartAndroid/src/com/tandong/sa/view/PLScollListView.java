...
public class PLScollListView extends ListView implements OnScrollListener {
	...
	public PLScollListView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init(context);
	}

	public PLScollListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
	...
	public void init(Context context) {
		mDefaultImageViewHeight = context.getResources().getDimensionPixelSize(
				getResources().getIdentifier("size_default_height", "dimen", context.getPackageName()));
		// mDefaultImageViewHeight =
