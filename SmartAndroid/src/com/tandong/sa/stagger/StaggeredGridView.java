...
package com.tandong.sa.stagger;
	...
	public StaggeredGridView(final Context context, final AttributeSet attrs, final int defStyle) {
		...
		if (attrs != null) {
			...
			TypedArray typedArray = context.obtainStyledAttributes(attrs,
					new int[] { getResources()
							.getIdentifier("StaggeredGridView", "styleable", context.getPackageName()) }, defStyle, 0);
			// TypedArray typedArray = context.obtainStyledAttributes(attrs,
			// R.styleable.StaggeredGridView, defStyle, 0);

			mColumnCount = typedArray.getInteger(
					getResources().getIdentifier("StaggeredGridView_column_count", "styleable",
							context.getPackageName()), 0);
			// mColumnCount =
			// typedArray.getInteger(R.styleable.StaggeredGridView_column_count,
			// 0);
			...
			if (mColumnCount > 0) {
				...
				mColumnCountPortrait = typedArray.getInteger(
						getResources().getIdentifier("StaggeredGridView_column_count_portrait", "styleable",
								context.getPackageName()),
						// mColumnCountPortrait =
						// typedArray.getInteger(R.styleable.StaggeredGridView_column_count_portrait,
						DEFAULT_COLUMNS_PORTRAIT);
				mColumnCountLandscape = typedArray.getInteger(
						getResources().getIdentifier("StaggeredGridView_column_count_landscape", "styleable",
								context.getPackageName()),
						// mColumnCountLandscape =
						// typedArray.getInteger(R.styleable.StaggeredGridView_column_count_landscape,
						DEFAULT_COLUMNS_LANDSCAPE);
			}

			mItemMargin = typedArray.getDimensionPixelSize(
					getResources()
							.getIdentifier("StaggeredGridView_item_margin", "styleable", context.getPackageName()), 0);
			// mItemMargin =
			// typedArray.getDimensionPixelSize(R.styleable.StaggeredGridView_item_margin,
			// 0);
			mGridPaddingLeft = typedArray.getDimensionPixelSize(
					getResources().getIdentifier("StaggeredGridView_grid_paddingLeft", "styleable",
							context.getPackageName()), 0);
			// mGridPaddingLeft =
			// typedArray.getDimensionPixelSize(R.styleable.StaggeredGridView_grid_paddingLeft,
			// 0);
			mGridPaddingRight = typedArray.getDimensionPixelSize(
					getResources().getIdentifier("StaggeredGridView_grid_paddingRight", "styleable",
							context.getPackageName()), 0);
			// mGridPaddingRight =
			// typedArray.getDimensionPixelSize(R.styleable.StaggeredGridView_grid_paddingRight,
			// 0);
			mGridPaddingTop = typedArray.getDimensionPixelSize(
					getResources().getIdentifier("StaggeredGridView_grid_paddingTop", "styleable",
							context.getPackageName()), 0);
			// mGridPaddingTop =
			// typedArray.getDimensionPixelSize(R.styleable.StaggeredGridView_grid_paddingTop,
			// 0);
			mGridPaddingBottom = typedArray.getDimensionPixelSize(
					getResources().getIdentifier("StaggeredGridView_grid_paddingBottom", "styleable",
							context.getPackageName()), 0);
			// mGridPaddingBottom =
			// typedArray.getDimensionPixelSize(R.styleable.StaggeredGridView_grid_paddingBottom,
			// 0);
